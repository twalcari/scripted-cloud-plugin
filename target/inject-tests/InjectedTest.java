...
public class InjectedTest extends junit.framework.TestCase {
  public static junit.framework.Test suite() throws Exception {
    ...
    parameters.put("basedir","F:\\cloudscraper_jenkins\\scripted-cloud-plugin");
    parameters.put("artifactId","scripted-cloud-plugin");
    parameters.put("outputDirectory","F:\\cloudscraper_jenkins\\scripted-cloud-plugin\\target\\classes");
    parameters.put("testOutputDirectory","F:\\cloudscraper_jenkins\\scripted-cloud-plugin\\target\\test-classes");
